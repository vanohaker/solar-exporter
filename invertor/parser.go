...
var (
	VoltageData invertorVoltageData
)

func ParseInvertorVoltages(message []byte) invertorVoltageData {
	...
	inputACvoltage, err := strconv.ParseFloat(matchGroupsData[r.SubexpIndex("inputACvoltage")], 64)
	if err != nil {
