...
3) Кабель USB-RS232 и переходник DB9-8P8C(RJ45). Можно обойтись и без такого кабеля если использовать имеющийся находящийся на плвате Serial интерфейс.
...
### Команды инвертора
Примерный список команд которые программа WatchPower посылает инвертору

|  Команда | Пример ответа | Описание |
|:---------|:--------------|:---------|
| 5150495249F8540D | 
